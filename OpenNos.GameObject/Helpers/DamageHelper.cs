...
namespace OpenNos.GameObject.Helpers
{
    public class DamageHelper
    {
        ...
        public static int Defence { get; internal set; }
        public static int DefenceRate { get; internal set; }
        public static int MagicalDefence { get; internal set; }
        public static int DarkResistance { get; internal set; }
        public static int FireResistance { get; internal set; }
        public static int LightResistance { get; internal set; }
        public static int WaterResistance { get; internal set; }
        public static int DistanceCritical { get; internal set; }
        public static int DistanceCriticalRate { get; internal set; }
        public static int DistanceDefence { get; internal set; }
        public static int DistanceRate { get; internal set; }
        public static int DistanceDefenceRate { get; internal set; }
        public static int MaxDistance { get; internal set; }
        public static int MinDistance { get; internal set; }
        public static int Element { get; internal set; }
        public static int ElementRate { get; internal set; }
        public static int HitCritical { get; internal set; }
        public static int HitCriticalRate { get; internal set; }
        public static int HitRate { get; internal set; }
        public static int MaxHit { get; internal set; }
        public static int MinHit { get; internal set; }
        public static int Hp { get; internal set; }
        public static int HPMax { get; internal set; }
        public static int MPMax { get; internal set; }
        public static int Mp { get; internal set; }
            ...
            ref bool onyxWings)
        {
            ...
            if (defender.Buffs.Any(s => s.Card.CardId == 577))
            {
        ...
        public int CalculateDamage(BattleEntity battleEntity, BattleEntity battleEntityDefense, Skill skill, ref int hitmode, ref bool onyxWings, object damageAb)
        {
